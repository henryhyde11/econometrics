...
"DECISIÓN"
if(pv_ec_24>=0.05) {"Aceptamos H0"} else {"Rechazar H0: Concluir cambio en el intercepto"}
...
"DECISIÓN"
if(pv_ec_27>=0.05) {"Aceptamos H0"} else {"Rechazar H0: Concluir cambio en la pendiente"}
